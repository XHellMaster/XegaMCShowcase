...
public class SKSummonAbility extends Ability {
    public SKSummonAbility(AbilityType type, Entity ent) {
        super(type, ent);
    }
    public void trigger() {
        ...
        if (!sk.died) {
            ...
            SkeletonMinion s3 = new SkeletonMinion(loc03, Main.getInstance(), durations);
            SkeletonMinion s4 = new SkeletonMinion(loc04, Main.getInstance(), durations);
                    ...
                    if (!sk.died) {
                        if(!s1.isDeadOrDying()) {
                            for (double i=0; i < 2 * Math.PI ; i +=density) {
                                ...
                                Particle.DustOptions dust1 = new Particle.DustOptions(Color.fromRGB(230, 115, 0), 1);
